...
namespace Application.ChatMessages.Model
{
    public class Modifier
    {
        ...
        private static string[] _possibleDescriptions = new string[] { "% Zoom", "% Weapon Recoil", "% Toxin", "% Status Duration", "% Status Chance", "% Critical Hit Chance for Slide Attack", "% Slash", "s Combo Duration", "% Reload Speed", "% Range", "% Puncture", "Punch Through", "% Projectile Flight Speed", "% Multishot", "% Melee Damage", "% Magazine Capacity", "% Impact", "% Heat", "% Fire Rate(x2 for Bows)", "% Fire Rate", "% Finisher Damage", "% Electricity", "% Damage to Infested", "% Damage to Grineer", "% Damage to Corpus", "% Damage", "% Critical Damage", "% Critical Chance", "% Cold", "% Channeling Efficiency", "% Channeling Damage", "% Attack Speed", "% Ammo Maximum" };
